  ...
  return (
    <section className="relative z-10 w-full max-w-4xl mx-auto px-4 sm:px-6 pt-8 sm:pt-16 pb-16 sm:pb-24 border-t border-white/10 text-left">
      ...
      <div className="text-center max-w-2xl mx-auto mb-6 sm:mb-9 space-y-2.5 sm:space-y-3">
        <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/5 border border-white/10 text-[11px] font-mono text-brand-orange font-semibold">
          ...
          return (
            ...
            >
              <button
                ...
                className="w-full px-5 sm:px-7 py-4 sm:py-5 flex items-center justify-between text-left gap-4 cursor-pointer select-none group"
              >
              ...
              {isOpen && (
                <div className="px-5 sm:px-7 pb-5 pt-0 text-xs sm:text-[13.5px] leading-relaxed text-neutral-300 font-normal animate-in fade-in slide-in-from-top-1 duration-200 pr-8 sm:pr-12">
                  <p className="text-neutral-300/90 leading-relaxed font-normal">
                    {faq.answer}
                  </p>
                </div>
              )}
