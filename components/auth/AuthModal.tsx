          ...
          {authModalMode === 'login' && (
            <form onSubmit={handleLoginSubmit} className="space-y-4">
              ...
              <div className="space-y-1.5 text-left">
                <label htmlFor="modal-login-password" className="text-sm font-semibold text-neutral-200 block">
                  Password
                </label>
            ...
            <>
              ...
              <div className="flex items-center justify-center gap-3.5 pt-1">
                <button
                  ...
                  className="w-16 h-12 rounded-xl bg-neutral-900/90 hover:bg-white border border-neutral-800 hover:border-white flex items-center justify-center transition-all duration-200 cursor-pointer shadow-sm hover:scale-[1.03] active:scale-[0.97]"
                ...
                <button
                  ...
                  className="group w-16 h-12 rounded-xl bg-neutral-900/90 hover:bg-white border border-neutral-800 hover:border-white flex items-center justify-center transition-all duration-200 cursor-pointer shadow-sm hover:scale-[1.03] active:scale-[0.97]"
